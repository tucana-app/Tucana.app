...
module.exports = {
  ...
  textTemplate: (user, payload) => {
    ...
    return `You booking for ride by "${booking.Ride.Driver.User.firstName}" from ${booking.Ride.cityOrigin} to ${booking.Ride.cityDestination} has been refused. Reason: ${formValues.comment}`;
  },
