...
function Home() {
  ...
  // It redirects the user according to where he/she is coming from
  if (!localData) {
  ...
  return (
    <Container>
      ...
      <Row className="justify-content-center align-content-center mb-5">
        ...
        >
          <img src={logo} width={300} alt="Tucána logo" className="img-fluid" />
          <p className="mb-0">{t("translation:global.catchPhrase")}</p>
        </Col>
      </Row>
      ...
      <Row className="mb-5">
        <Col xs={12} sm={10} md={8} lg={6} xl={4} className="mx-auto">
          <LinkContainer to="/signup">
            <Button variant="outline-success" size="lg" className="py-2 w-100">
