      ...
      {isFormSearchRideSubmitted ? (
        <Container>
          ...
          <Row className="mb-3 mx-1 mx-sm-0">
            <Col xs={12} sm={10} md={8} lg={6} xl={4} className="mx-auto px-0">
              ...
              {filteredRidesData.map((ride, index) => (
                <Row key={index} className="mb-3 mx-1 mx-sm-0">
                  <Col
                    ...
                    lg={6}
                    xl={4}
                    className="container-box bg-white hvr-grow hvr-grow-sm"
                  >
                    <LinkContainer
            ...
            <>
              <Row className="mt-5">
                ...
                >
                  ...
                  <p className="mb-0">{t("translation:searchRides.message")}</p>
                </Col>
              </Row>
              <Row className="mt-4">
                <Col
