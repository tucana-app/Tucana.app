...
class inputSearchTo extends Component {
  constructor(props) {
    super(props);
    this.state = {
      search: "",
  ...
  handleSelectSuggest = (geocodedPrediction, originalPrediction) => {
    // console.log(geocodedPrediction.geometry.viewport.Ra.g);
    // console.log(geocodedPrediction.geometry.viewport.La.g);
...
export default withTranslation()(inputSearchTo);
